...
ActiveRecord::Schema[7.0].define(version: 2024_11_28_143519) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "loan_repay_histories", force: :cascade do |t|
    t.bigint "user_id"
    ...
    t.index ["loan_request_id"], name: "index_loan_repay_histories_on_loan_request_id"
    t.index ["user_id"], name: "index_loan_repay_histories_on_user_id"
  end
